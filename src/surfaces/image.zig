...
pub fn getHeight(surface: *c.struct__cairo_surface) u16 {
    return @intCast(c.cairo_image_surface_get_height(surface));
}
...
pub fn getStride(surface: *c.struct__cairo_surface) u16 {
    return @intCast(c.cairo_image_surface_get_stride(surface));
}
...
pub fn getWidth(surface: *c.struct__cairo_surface) u16 {
    return @intCast(c.cairo_image_surface_get_width(surface));
}
